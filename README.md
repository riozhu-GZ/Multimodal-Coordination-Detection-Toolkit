...
The toolkit is extended on the Coordination Network Toolkit (Graham et al., 2024) https://github.com/QUT-Digital-Observatory/coordination-network-toolkit
...
### TiCNet — Transverse-intensive coordination network
Coordinated campaigns often involve accounts with dense, time-concentrated group activity sharing near-identical multimodal content within tight time windows. 
### LiCNet — Longitudinal intensive Coordination Network
LiCNet captures coordination through recurring interactions distributed over time. Unlike TiCNet, it does not require community structure; instead, it surfaces all account pairs that share sufficiently similar content at least `min_edge_weight` times within the observation period. Both CIB (more synchronised) and asynchronised coordination are detected.

| Pattern | Interpretation |
|---|---|
| **CIB** (Coordinated Inauthentic Behaviour) | Synchronous, tightly timed posting — characteristic of bot-driven or scripted campaigns (Graham et al., 2024) |
| **Asynchronous coordination** | Dispersed but still intentional amplification — characteristic of loosely organised human networks |
